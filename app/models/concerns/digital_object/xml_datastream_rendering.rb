module DigitalObject::XmlDatastreamRendering
  ...
  def render_xml_datastream(xml_datastream)
    ...
    dynamic_field_group_string_keys_to_objects = Hash[DynamicFieldGroup.all.map{|dfg| [dfg.string_key, dfg.xml_translation]}]
    ...
    Hyacinth::XMLGenerator.new(base_translation_logic, self.dynamic_field_data, dynamic_field_group_string_keys_to_objects, internal_fields).tap do |xml_gen|
      xml_gen.generate.to_xml(indent: 2)
    end
  end
