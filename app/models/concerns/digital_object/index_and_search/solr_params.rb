    ...
    def set_facet_params_for(facet_params, solr_params, dynamic_field_string_keys_to_dynamic_fields)
      ...
      if facet_params.blank?
        ...
        if facet_params['field'].present?
          ...
          facet_fields += ['project_display_label_sim', 'digital_object_type_display_label_sim', 'enabled_publish_target_display_label_sim', 'asset_dc_type_sim', 'has_child_digital_objects_bi']
