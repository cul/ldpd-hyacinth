...
module DigitalObjectConcerns
  module AttributeAssignment
    ...
    include DigitalObjectConcerns::AttributeAssignment::Descriptive
    ...
    # @param merge_descriptive [boolean] If true, merges given descriptive Hash into into existing descriptive data.
    #        If false, replaces existing descriptive data with new descriptive Hash.
    # @param opts [Hash] A hash of options. Options include:
    #             :merge_descriptive [boolean] If true, merges given descriptive Hash into
    #                                             into existing descriptive data.
    #             :merge_rights [boolean] If true, merges given rights_data Hash into
    #                                     into existing rights_data.
    def assign_attributes(new_digital_object_data, merge_descriptive: true, merge_rights: true)
      ...
      assign_descriptive(new_digital_object_data, merge_descriptive)
