class ExportSearchResultsToCsvJob
  ...
  INTERNAL_FIELD_REGEXES_ALLOWED_ON_IMPORT = [
    '_pid', '_doi', '_merge_dynamic_fields', '_publish', '_first_published', '_digital_object_type.string_key', '_import_file.import_type', '_import_file.import_path', '_import_file.original_file_path', '_import_file.access_copy_import_path', '_restrictions.restricted_size_image', '_restrictions.restricted_onsite',
