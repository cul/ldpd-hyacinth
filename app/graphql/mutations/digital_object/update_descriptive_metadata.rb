...
module Mutations
  module DigitalObject
    class UpdateDescriptiveMetadata < Mutations::BaseMutation
      ...
      def resolve(id:, descriptive_metadata:, identifiers:, optimistic_lock_token:)
        digital_object = ::DigitalObject::Base.find(id)
        ability.authorize! :update, digital_object
        digital_object.assign_attributes(
          'identifiers' => identifiers, 'descriptive_metadata' => descriptive_metadata, 'optimistic_lock_token' => optimistic_lock_token
        )
