class DynamicFieldsController < ApplicationController
  ...
  private
    ...
    def dynamic_field_params
      params.require(:dynamic_field).permit(:string_key, :display_label, :parent_dynamic_field_group_id, :sort_order, :dynamic_field_type, :additional_data_json, :is_keyword_searchable, :is_facet_field, :facet_field_label, :is_searchable_identifier_field, :is_searchable_title_field, :is_single_field_searchable, :created_by_id, :updated_by_id)
    end
end
