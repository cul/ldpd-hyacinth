    ...
    if ! params[:ticketid]
      ...
      if user_uni.present?
        ...
        unless possible_user.nil?
          ...
          session[:signed_in_using_uni] = true # Use this session variable to know when to do a Wind logout upon Devise logout
  ...
  def do_cas_login
    ...
    if ! params[:ticket]
      ...
      if user_uni.present?
        ...
        unless possible_user.nil?
          sign_in possible_user, :bypass => true
          session[:signed_in_using_uni] = true # Use this session variable to know when to do a CAS logout upon Devise logout
          flash[:notice] = 'You are now logged in.'
