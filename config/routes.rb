...
Rails.application.routes.draw do
  ...
  resources :digital_objects do
    ...
    member do
      ...
      get 'synchronized_transcript', action: 'download_synchronized_transcript'
      put 'synchronized_transcript', action: 'update_synchronized_transcript'
      delete 'clear_synchronized_transcript_and_reimport_transcript', action: 'clear_synchronized_transcript_and_reimport_transcript'
      get 'media_view'
      get 'mods'
      get 'xacml'
