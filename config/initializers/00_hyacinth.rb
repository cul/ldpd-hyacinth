...
%i(digital_object_data_directory upload_directory default_asset_home default_service_copy_home
   csv_export_directory processed_csv_import_directory access_copy_directory
