...
describe Hyacinth::Adapters::PreservationAdapter::Fedora3 do
  ...
  let(:adapter_args) { { url: 'foo', password: 'foo', user: 'foo', time_zone: 'America/New_York', pid_generator: pid_generator, resource_dsid_overrides: resource_dsid_overrides } }
  let(:adapter) do
  ...
  describe "#persist_impl" do
    ...
    context "field exports" do
      ...
      it "makes core object property assignments" do
        ...
        hyacinth_object.title = { 'value' => { 'sort_portion' => digital_object_title } }
        adapter.persist_impl("fedora3://#{object_pid}", hyacinth_object)
    ...
    context "Struct properties" do
      ...
      let(:child_hyacinth_object) do
        ...
        obj.title = { 'value' => { 'sort_portion' => child_object_title } }
        obj
      end
