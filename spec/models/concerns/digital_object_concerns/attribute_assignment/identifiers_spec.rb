...
RSpec.describe DigitalObjectConcerns::AttributeAssignment::Identifiers do
  ...
  context "#assign_identifiers" do
    it "sets the identifiers each time it's called" do
      expect(digital_object.identifiers).to be_blank
      digital_object.assign_identifiers(digital_object_data_with_identifiers)
      expect(digital_object.identifiers).to eq(identifiers)
      digital_object.assign_identifiers(digital_object_data_with_different_identifiers)
