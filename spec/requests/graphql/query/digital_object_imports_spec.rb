        ...
        %(
          {
            "batchImport": {
              "digitalObjectImports": {
                "nodes": [
                  {
                    "digitalObjectData": "{\\"descriptive\\":{\\"identifier\\":[{\\"value\\":\\"something_1\\"}]}}",
                    "importErrors": [],
                    "index": 19,
                    "status": "in_progress"
                  },
                  {
                    "digitalObjectData": "{\\"descriptive\\":{\\"note\\":[{\\"value\\":\\"fantastic note\\"}]}}",
                    "importErrors": [],
                    "index": 25,
                    "status": "pending"
                  },
                  {
                    "digitalObjectData": "{\\"descriptive\\":{\\"abstract\\":[{\\"abstract_value\\":\\"some abstract\\"}]}}",
                    "importErrors": [],
                    "index": 34,
                    "status": "in_progress"
                  },
                  {
                     "digitalObjectData": "{\\"descriptive\\":{\\"date\\":[{\\"value\\":\\"2001\\"}]}}",
                    "importErrors": [],
                    "index": 89,
                    "status": "success"
                  },
                  {
                    "digitalObjectData": "{\\"descriptive\\":{\\"location\\":[{\\"value\\":\\"some place\\"}]}}",
                    "importErrors": [
