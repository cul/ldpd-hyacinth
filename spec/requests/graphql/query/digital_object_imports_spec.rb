            ...
            "batchImport": {
              "digitalObjectImports": {
                "nodes": [
                  ...
                  {
                    "digitalObjectData": "{\\"digital_object_type\\":\\"item\\",\\"descriptive_metadata\\":{\\"abstract\\":[{\\"value\\":\\"some abstract\\"}]},\\"primary_project\\":{\\"string_key\\":\\"great_project\\"},\\"title\\":{\\"sort_portion\\":\\"The\\",\\"non_sort_portion\\":\\"Cool Item\\"}}",
                    "importErrors": [],
                    "index": 34,
                    "status": "PENDING"
                  },
