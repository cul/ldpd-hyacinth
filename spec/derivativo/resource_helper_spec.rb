...
describe Derivativo::ResourceHelper do
  describe '.resource_location_for_derivativo' do
    ...
    it 'returns the expected value for a disk-based resource' do
      expect(described_class.resource_location_for_derivativo(disk_based_resource)).to eq('file:///path/to/file')
    end

    it 'returns the expected value for a NON-disk-based resource' do
      expect { described_class.resource_location_for_derivativo(non_disk_based_resource) }.to raise_error(NotImplementedError)
    end
  end
end
