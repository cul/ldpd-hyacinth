FactoryBot.define do
  ...
  factory :digital_object_test_subclass, class: DigitalObject::TestSubclass do
    ...
    factory :digital_object_test_subclass_with_complex_data do
      initialize_with do
        legend_of_lincoln_project = build(:legend_of_lincoln_project)
        ...
        instance.instance_variable_set('@created_by', build(:admin_user))
        instance.instance_variable_set('@updated_by', build(:non_admin_user))
        instance.instance_variable_set('@last_published_by', build(:non_admin_user))
        ...
        instance.instance_variable_set('@group', build(:lincoln_historical_society_group))
