...
ActiveRecord::Schema.define(version: 20151223183540) do
  ...
  add_index "publish_targets", ["pid"], name: "index_publish_targets_on_pid", unique: true
  add_index "publish_targets", ["string_key"], name: "index_publish_targets_on_string_key", unique: true
