  ...
  class DynamicFieldsMap
    ...
    private
      ...
      def generate_map(for_metadata_form)
        ...
        raise ArgumentError, "for_metadata_form parameters must be one of #{valid_metadata_forms}. Given #{for_metadata_form}." if (for_metadata_form - valid_metadata_forms).present?
